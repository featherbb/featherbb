...
?>
<div class="blockform">
	<h2><span><?php echo __('Login') ?></span></h2>
	<div class="box">
		<form id="login" method="post" action="<?php echo get_link('login/action/in/') ?>" onsubmit="return process_form(this)">
			...
			<div class="inform">
				<fieldset>
					...
					<div class="infldset">
						...
						<label class="conl required"><strong><?php echo __('Username') ?> <span><?php echo __('Required') ?></span></strong><br /><input type="text" name="req_username" size="25" maxlength="25" tabindex="1" /><br /></label>
			...
			<p class="buttons"><input type="submit" name="login" value="<?php echo __('Login') ?>" tabindex="4" /></p>
		</form>
	</div>
</div>