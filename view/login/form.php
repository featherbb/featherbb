			...
			<div class="inform">
				<fieldset>
					...
					<div class="infldset">
						...
						<p class="actions"><span><a href="<?php echo get_link('register/') ?>" tabindex="5"><?php _e('Not registered') ?></a></span> <span><a href="<?php echo get_link('login/action/forget/') ?>" tabindex="6"><?php _e('Forgotten pass') ?></a></span></p>
					</div>
				</fieldset>
			</div>
