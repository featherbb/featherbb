...
<div class="blockform">
	...
	<div class="box">
		<form id="login" method="post" action="<?php echo $feather->url->get_link('login/action/in/') ?>" onsubmit="return process_form(this)">
			...
			<div class="inform">
				<fieldset>
					...
					<div class="infldset">
						...
						<p class="actions"><span><a href="<?php echo $feather->url->get_link('register/') ?>" tabindex="5"><?php _e('Not registered') ?></a></span> <span><a href="<?php echo $feather->url->get_link('login/action/forget/') ?>" tabindex="6"><?php _e('Forgotten pass') ?></a></span></p>
					</div>
				</fieldset>
			</div>
