...
<div class="linkst">
	<div class="inbox">
		<ul class="crumbs">
			...
			<li><span>»&#160;</span><a href="<?php echo $feather->url->get_link('forum/'.$cur_posting['id'].'/'.$url_forum.'/') ?>"><?php echo feather_escape($cur_posting['forum_name']) ?></a></li>
<?php if ($feather->request->post('req_subject')): ?>			<li><span>»&#160;</span><?php echo feather_escape($feather->request->post('req_subject')) ?></li>
<?php endif; ?>
<?php if (isset($cur_posting['subject'])): ?>			<li><span>»&#160;</span><a href="<?php echo $feather->url->get_link('topic/'.$tid.'/'.$url_topic.'/') ?>"><?php echo feather_escape($cur_posting['subject']) ?></a></li>
