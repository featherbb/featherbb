...
<title><?php echo Utils::generate_page_title($page_title, $p) ?></title>
<link rel="stylesheet" type="text/css" href="<?php echo $feather->url->base() ?>/style/themes/<?php echo $feather->user->style.'.css' ?>" />
<?php
