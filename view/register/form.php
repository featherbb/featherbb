...
<?php if ($feather->forum_settings['o_regs_verify'] == '0'): ?>			<div class="inform">
				<fieldset>
...
<?php endif; ?>			<div class="inform">
				<fieldset>
					<legend><?php echo($feather->forum_settings['o_regs_verify'] == '1') ? __('Email legend 2') : __('Email legend') ?></legend>
					<div class="infldset">
