...
<?php endif; ?>						<label class="required"><strong><?php echo __('Message') ?> <span><?php echo __('Required') ?></span></strong><br />
						...
						<ul class="bblinks">
							<li><span><a href="help.php#bbcode" onclick="window.open(this.href); return false;"><?php echo __('BBCode') ?></a> <?php echo($feather_config['p_message_bbcode'] == '1') ? __('on') : __('off'); ?></span></li>
							<li><span><a href="help.php#url" onclick="window.open(this.href); return false;"><?php echo __('url tag') ?></a> <?php echo($feather_config['p_message_bbcode'] == '1' && $feather->user->g_post_links == '1') ? __('on') : __('off'); ?></span></li>
							<li><span><a href="help.php#img" onclick="window.open(this.href); return false;"><?php echo __('img tag') ?></a> <?php echo($feather_config['p_message_bbcode'] == '1' && $feather_config['p_message_img_tag'] == '1') ? __('on') : __('off'); ?></span></li>
							<li><span><a href="help.php#smilies" onclick="window.open(this.href); return false;"><?php echo __('Smilies') ?></a> <?php echo($feather_config['o_smilies'] == '1') ? __('on') : __('off'); ?></span></li>
						</ul>
					</div>
				</fieldset>
			</div>
