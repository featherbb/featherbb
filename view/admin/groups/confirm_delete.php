...
?>
	...
	<div class="blockform">
		...
		<div class="box">
			<form method="post" action="<?php echo $feather->url->get_link('admin/groups/delete/'.$id.'/') ?>">
				<input type="hidden" name="<?php echo $csrf_key; ?>" value="<?php echo $csrf_token; ?>">
				<div class="inform">
				<input type="hidden" name="group_to_delete" value="<?php echo $feather->url->get_link('admin/groups/delete/'.$id.'/') ?>" />
					<fieldset>
