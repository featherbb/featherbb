...
<div class="blockform">
	<h2><span><?php echo __('Group delete head') ?></span></h2>
	<div class="box">
		<form method="post" action="<?php echo get_link('admin/groups/delete/'.$id.'/') ?>">
			...
			<p class="buttons"><input type="submit" name="del_group_comply" value="<?php echo __('Delete') ?>" tabindex="1" /><a href="javascript:history.go(-1)" tabindex="2"><?php echo __('Go back') ?></a></p>
		</form>
	</div>
</div>
