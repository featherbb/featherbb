					...
					<fieldset>
						...
						<div class="infldset">
							<table class="aligntop">
								<tr>
									<th scope="row"><?php _e('Add forum label') ?><div><input type="submit" name="add_forum" value="<?php _e('Add forum') ?>" tabindex="2" /></div></th>
									<td>
...
if (!empty($forum_data)) {
    ?>
		<h2 class="block2"><span><?php _e('Edit forums head') ?></span></h2>
		<div class="box">
    ...
    foreach ($forum_data as $forum) {
        ...
        if ($cur_category != 0) {
            ...
            ?>
				<div class="inform">
					<fieldset>
						<legend><?php _e('Category subhead') ?> <?php echo feather_escape($forum['cat_name']) ?></legend>
						<div class="infldset">
							<table>
							<thead>
								<tr>
...
<?php
        ...
        ?>
								<tr>
									<td class="tcl"><a href="<?php echo get_link('admin/forums/edit/'.$forum['fid'].'/') ?>" tabindex="<?php echo $cur_index++ ?>"><?php _e('Edit link') ?></a> | <a href="<?php echo get_link('admin/forums/delete/'.$forum['fid'].'/') ?>" tabindex="<?php echo $cur_index++ ?>"><?php _e('Delete link') ?></a></td>
