...
?>
	...
	<div class="blockform">
		...
		<div class="box">
			<form method="post" action="<?php echo $feather->url->get_link('admin/forums/add') ?>">
...
if (!empty($forum_data)) {
    ?>
		...
		<div class="box">
			<form id="edforum" method="post" action="<?php echo $feather->url->get_link('admin/forums/') ?>">
				<input type="hidden" name="<?php echo $csrf_key; ?>" value="<?php echo $csrf_token; ?>">
...
<?php
	foreach ($cat_data['cat_forums'] as $forum) {
        ?>
								<tr>
									<td class="tcl"><a href="<?php echo $feather->url->get_link('admin/forums/edit/'.$forum['forum_id'].'/') ?>" tabindex="<?php echo $cur_index++ ?>"><?php _e('Edit link') ?></a> | <a href="<?php echo $feather->url->get_link('admin/forums/delete/'.$forum['forum_id'].'/') ?>" tabindex="<?php echo $cur_index++ ?>"><?php _e('Delete link') ?></a></td>
