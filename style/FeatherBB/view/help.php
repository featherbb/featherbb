...
<div class="box">
	<div class="inbox">
		...
		<p><code>[topic=1]<?php _e('Test topic') ?>[/topic]</code> <?php _e('produces') ?> <samp><a href="<?php echo get_link('topic/1/') ?>"><?php _e('Test topic') ?></a></samp></p>
		<p><code>[topic]1[/topic]</code> <?php _e('produces') ?> <samp><a href="<?php echo get_link('topic/1/') ?>"><?php echo get_link('topic/1/') ?></a></samp></p>
		<p><code>[post=1]<?php _e('Test post') ?>[/post]</code> <?php _e('produces') ?> <samp><a href="<?php echo get_link('post/1/#p1') ?>"><?php _e('Test post') ?></a></samp></p>
		<p><code>[post]1[/post]</code> <?php _e('produces') ?> <samp><a href="<?php echo get_link('post/1/#p1') ?>"><?php echo get_link('post/1/#p1') ?></a></samp></p>
		<p><code>[forum=1]<?php _e('Test forum') ?>[/forum]</code> <?php _e('produces') ?> <samp><a href="<?php echo get_link('topic/1/') ?>"><?php _e('Test forum') ?></a></samp></p>
		<p><code>[forum]1[/forum]</code> <?php _e('produces') ?> <samp><a href="<?php echo get_link('forum/1/') ?>"><?php echo get_link('forum/1/') ?></a></samp></p>
		<p><code>[user=2]<?php _e('Test user') ?>[/user]</code> <?php _e('produces') ?> <samp><a href="<?php echo get_link('user/2/') ?>"><?php _e('Test user') ?></a></samp></p>
		<p><code>[user]2[/user]</code> <?php _e('produces') ?> <samp><a href="<?php echo get_link('user/2/') ?>"><?php echo get_link('user/2/') ?></a></samp></p>
	</div>
	<div class="inbox">
		<p><a name="img"></a><?php _e('Images info') ?></p>
		<p><code>[img=<?php _e('FluxBB bbcode test') ?>]<?php echo feather_escape(get_base_url(true)) ?>/img/test.png[/img]</code> <?php _e('produces') ?> <samp><img style="height: 21px" src="<?php echo feather_escape(get_base_url(true)) ?>/img/test.png" alt="<?php _e('FluxBB bbcode test') ?>" /></samp></p>
	</div>
</div>
