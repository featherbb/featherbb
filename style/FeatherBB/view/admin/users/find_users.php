...
<div class="linkst">
	<div class="inbox crumbsplus">
		<ul class="crumbs">
			<li><a href="<?php echo $feather->url->get_link('admin/index/') ?>"><?php _e('Admin').' '.__('Index') ?></a></li>
...
<form id="search-users-form" action="<?php echo $feather->url->get_link('admin/users/') ?>" method="post">
        ...
        foreach ($user_data as $user) {
            ?>
				<tr>
					...
					<td class="tcr"><?php echo '<a href="'.$feather->url->get_link('admin/users/ip-stats/id/'.$user['id'].'/').'">'.__('Results view IP link').'</a> | <a href="'.$feather->url->get_link('search/?action=show_user_posts&amp;user_id='.$user['id']).'">'.__('Results show posts link').'</a>' ?></td>
