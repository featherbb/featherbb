...
?>
	...
	<div class="blockform">
		...
		<div class="box">
			<form method="get" action="<?php echo $feather->url->get_link('admin/maintenance/') ?>">
				<div class="inform">
					<input type="hidden" name="action" value="rebuild" />
					<fieldset>
						<legend><?php _e('Rebuild index subhead') ?></legend>
						<div class="infldset">
							<p><?php printf(__('Rebuild index info'), '<a href="'.$feather->url->get_link('admin/options/#maintenance').'">'.__('Maintenance mode').'</a>') ?></p>
			...
			<form method="post" action="<?php echo $feather->url->get_link('admin/maintenance/') ?>" onsubmit="return process_form(this)">
				...
				<div class="inform">
					...
					<fieldset>
						...
						<div class="infldset">
							...
							<p class="topspace"><?php printf(__('Prune info'), '<a href="'.$feather->url->get_link('admin/options/#maintenance').'">'.__('Maintenance mode').'</a>') ?></p>
