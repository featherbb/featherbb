...
<div class="blockform">
	<h2><span><?php echo __('Ban advanced head') ?></span></h2>
	<div class="box">
		<form id="bans2" method="post" action="">
			<div class="inform">
				...
				<?php endif; ?><fieldset>
					<legend><?php echo __('Ban advanced subhead') ?></legend>
					<div class="infldset">
						<table class="aligntop">
							<tr>
								...
								<td>
									...
									<span><?php echo __('Username help') ?></span>
								</td>
							</tr>
							<tr>
								...
								<td>
									<input type="text" name="ban_ip" size="45" maxlength="255" value="<?php if (isset($ban['ip'])) {
										...
										<span><?php echo __('IP help') ?><?php if ($ban['ban_user'] != '' && isset($ban['user_id'])) {
							...
							<tr>
								...
								<td>
									...
									<span><?php echo __('E-mail help') ?></span>
								</td>
							</tr>
						</table>
						<p class="topspace"><strong class="warntext"><?php echo __('Ban IP range info') ?></strong></p>
					</div>
				</fieldset>
			</div>
			<div class="inform">
			...
			<p class="submitend"><input type="submit" name="add_edit_ban" value="<?php echo __('Save') ?>" tabindex="6" /></p>
		</form>
	</div>
</div>
