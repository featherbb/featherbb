...
?>
	...
	<div class="blockform">
		...
		<div class="box">
			<form method="post" action="<?php echo get_link('admin/parser/') ?>" enctype="multipart/form-data">
				...
				<p class="submittop">
					<input type="submit" name="save" value="<?php echo __('Save changes') ?>" />
...
} ?> /> <strong><?php echo __('Yes') ?></strong>   <input type="radio" name="config[textile]" value="0"<?php if (!$config['textile']) {
    echo ' checked="checked"';
    ...
    echo ' checked="checked"';
} ?> /> <strong><?php echo __('Yes') ?></strong>   <input type="radio" name="config[quote_links]" value="0"<?php if (!$config['quote_links']) {
    echo ' checked="checked"';
} ?> /> <strong><?php echo __('No') ?></strong>
									</td>
									<td>
    ...
    echo ' checked="checked"';
} ?> /> <strong><?php echo __('Yes') ?></strong>   <input type="radio" name="config[quote_imgs]" value="0"<?php if (!$config['quote_imgs']) {
    echo ' checked="checked"';
} ?> /> <strong><?php echo __('No') ?></strong>
									</td>
									<td>
    ...
    echo ' checked="checked"';
} ?> /> <strong><?php echo __('Yes') ?></strong>   <input type="radio" name="config[click_imgs]" value="0"<?php if (!$config['click_imgs']) {
    echo ' checked="checked"';
} ?> /> <strong><?php echo __('No') ?></strong>
									</td>
									<td>
...
foreach ($bbcd as $tagname => $tagdata) {
    ...
    ?> /> <strong><?php echo __('Yes') ?></strong>   <input type="radio" name="<?php echo($tagname) ?>_in_post" value="0"<?php if (!$bbcd[$tagname]['in_post']) {
    echo ' checked="checked"';
}
    ?> /> <strong><?php echo __('No') ?></strong>
									</td>
    ...
    ?> /> <strong><?php echo __('Yes') ?></strong>   <input type="radio" name="<?php echo($tagname) ?>_in_sig" value="0"<?php if (!$bbcd[$tagname]['in_sig']) {
    echo ' checked="checked"';
}
    ?> /> <strong><?php echo __('No') ?></strong>
									</td>
