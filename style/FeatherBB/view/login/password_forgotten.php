...
<div class="blockform">
	...
	<div class="box">
		<form id="request_pass" method="post" action="<?php echo $feather->url->get_link('login/action/forget/') ?>" onsubmit="this.request_pass.disabled=true;if(process_form(this)){return true;}else{this.request_pass.disabled=false;return false;}">
