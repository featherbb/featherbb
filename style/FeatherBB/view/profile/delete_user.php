		...
		<form id="confirm_del_user" method="post" action="<?php echo get_link('user/'.$id.'/') ?>">
			...
			<div class="inform">
				<fieldset>
					...
					<div class="infldset">
						<p><?php echo $lang_profile['Confirmation info'].' <strong>'.feather_escape($username).'</strong>.' ?></p>
						<div class="rbox">
			...
			<p class="buttons"><input type="submit" name="delete_user_comply" value="<?php echo $lang_profile['Delete'] ?>" /> <a href="javascript:history.go(-1)"><?php echo __('Go back') ?></a></p>
		</form>
	</div>
</div>