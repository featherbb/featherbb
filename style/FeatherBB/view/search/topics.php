...
<tr class="<?php echo $cur_search['item_status'] ?>">
	...
	<td class="tcr"><?php echo '<a href="'.$feather->url->get_link('post/'.$cur_search['last_post_id'].'/#p'.$cur_search['last_post_id']).'">'.format_time($cur_search['last_post']).'</a> <span class="byuser">'.__('by').' '.feather_escape($cur_search['last_poster']) ?></span></td>
</tr>