...
<div id="reportform" class="blockform">
	...
	<div class="box">
		<form id="report" method="post" action="<?php echo $feather->url->get_link('report/'.$id.'/') ?>" onsubmit="this.submit.disabled=true;if(process_form(this)){return true;}else{this.submit.disabled=false;return false;}">
