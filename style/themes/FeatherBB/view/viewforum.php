...
<div class="linkst">
	<div class="inbox crumbsplus">
		<ul class="crumbs">
			...
			<li><span>»&#160;</span><strong><a href="<?php $feather->url->get('forum/'.$id.'/'.$url_forum.'/') ?>"><?php echo $feather->utils->escape($cur_forum['forum_name']) ?></a></strong></li>
		</ul>
		<div class="pagepost">
            ...
            foreach ($forum_data as $topic) {
                ...
                ?>
					<tr class="<?php echo $topic['item_status'] ?>">
						...
						<td class="tc2"><?php echo(is_null($topic['moved_to'])) ? $feather->utils->forum_number_format($topic['num_replies']) : '-' ?></td>
	<?php if ($feather->forum_settings['o_topic_views'] == '1'): ?>					<td class="tc3"><?php echo(is_null($topic['moved_to'])) ? $feather->utils->forum_number_format($topic['num_views']) : '-' ?></td>
	<?php endif;
