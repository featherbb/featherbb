...
'Running latest version message'    =>    'You are running the latest version of FeatherBB.',
'New version available message'        =>    'A new version of FeatherBB has been released. You can download the latest version at %s.',
'Deleted install.php redirect'        =>    'The file was successfully removed.',
'Delete install.php failed'            =>    'Could not remove install.php. Please do so by hand.',
'Not available'                        =>    'Not available',
'Forum admin head'                    =>    'Forum administration',
'NA'                                =>    'N/A',
'Welcome to admin'                    =>    'Welcome to the FeatherBB administration control panel. From here you can control vital aspects of the board. Depending on whether you are an administrator or a moderator you can:',
...
'Alerts head'                        =>    'Alerts',
'Install file exists'                =>    'The install folder still exists, but should be removed. %s.',
'Delete install file'                =>    'Delete it',
'About head'                        =>    'About FeatherBB',
'FeatherBB version label'                =>    'FeatherBB version',
'Check for upgrade'                    =>    'Check for upgrade',
'FeatherBB version data'                =>    'v%s - %s',
