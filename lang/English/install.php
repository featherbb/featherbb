...
'No DB extensions'				=>	'This PHP environment does not have support for any of the databases that FeatherBB supports. PHP needs to have support for either MySQL, PostgreSQL or SQLite in order for FeatherBB to be installed.',
'Administrator username'		=>	'Administrator\'s username',
'Administrator email'			=>	'Administrator\'s email',
'Board title'					=>	'Board title',
'Base URL'						=>	'The URL (without trailing slash) of your FeatherBB forum. This must be correct.',
'Required field'				=>	'is a required field in this form.',
'FeatherBB Installation'			=>	'FeatherBB Installation',
'Welcome'						=>	'You are about to install FeatherBB. In order to install FeatherBB, you must complete the form set out below. If you encounter any difficulties with the installation, please refer to the documentation.',
'Install'						=>	'Install FeatherBB %s',
...
'Info 4'						=>	'The name of the database you want to install FeatherBB on.',
...
'Info 6'						=>	'If you want to run multiple FeatherBB installations in a single database, change this.',
...
'Message'						=>	'If you are looking at this (which I guess you are), the install of FeatherBB appears to have worked! Now log in and head over to the administration control panel to configure your forum.',
'Test category'					=>	'Test category',
'Test forum'					=>	'Test forum',
'This is just a test forum'		=>	'This is just a test forum',
'Alert cache'					=>	'<strong>The cache directory is currently not writable!</strong> In order for FeatherBB to function properly, the directory <em>%s</em> must be writable by PHP. Use chmod to set the appropriate directory permissions. If in doubt, chmod to 0777.',
