...
class Register
{
    ...
    public function insert_user($user)
    {
        ...
        $intial_group_id = ($this->config['o_regs_verify'] == '0') ? $this->config['o_default_user_group'] : Config::get('forum_env')['FEATHER_UNVERIFIED'];
        ...
        if ($this->config['o_mailing_list'] != '') {
            ...
            if (isset($user['banned_email'])) {
                ...
                $mail_tpl = trim(file_get_contents(Config::get('forum_env')['FEATHER_ROOT'].'featherbb/lang/'.$this->user->language.'/mail_templates/banned_email_register.tpl'));
            ...
            if (!empty($dupe_list)) {
                ...
                $mail_tpl = trim(file_get_contents(Config::get('forum_env')['FEATHER_ROOT'].'featherbb/lang/'.$this->user->language.'/mail_templates/dupe_email_register.tpl'));
            ...
            if ($this->config['o_regs_report'] == '1') {
                ...
                $mail_tpl = trim(file_get_contents(Config::get('forum_env')['FEATHER_ROOT'].'featherbb/lang/'.$this->user->language.'/mail_templates/new_user.tpl'));
        ...
        if ($this->config['o_regs_verify'] == '1') {
            ...
            $mail_tpl = trim(file_get_contents(Config::get('forum_env')['FEATHER_ROOT'].'featherbb/lang/'.$this->user->language.'/mail_templates/welcome.tpl'));
