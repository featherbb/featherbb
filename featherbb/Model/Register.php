...
class Register
{
    ...
    public function check_for_errors()
    {
        ...
        // Antispam feature
        require FEATHER_ROOT.'featherbb/lang/'.$this->user->language.'/antispam.php';
    ...
    public function insert_user($user)
    {
        ...
        if ($this->config['o_mailing_list'] != '') {
            ...
            if (isset($user['banned_email'])) {
                ...
                $mail_tpl = trim(file_get_contents(FEATHER_ROOT.'featherbb/lang/'.$this->user->language.'/mail_templates/banned_email_register.tpl'));
            ...
            if (!empty($dupe_list)) {
                ...
                $mail_tpl = trim(file_get_contents(FEATHER_ROOT.'featherbb/lang/'.$this->user->language.'/mail_templates/dupe_email_register.tpl'));
            ...
            if ($this->config['o_regs_report'] == '1') {
                ...
                $mail_tpl = trim(file_get_contents(FEATHER_ROOT.'featherbb/lang/'.$this->user->language.'/mail_templates/new_user.tpl'));
        ...
        if ($this->config['o_regs_verify'] == '1') {
            ...
            $mail_tpl = trim(file_get_contents(FEATHER_ROOT.'featherbb/lang/'.$this->user->language.'/mail_templates/welcome.tpl'));
            ...
            redirect(Url::base(),__('Reg email').' <a href="mailto:'.feather_escape($this->config['o_admin_email']).'">'.feather_escape($this->config['o_admin_email']).'</a>.');
        ...
        redirect(Url::base(), __('Reg complete'));
    }
}
