...
class Users
{
    public function __construct()
    {
        ...
        load_textdomain('featherbb', Config::get('forum_env')['FEATHER_ROOT'].'featherbb/lang/'.Container::get('user')->language.'/admin/users.mo');
    }
    ...
    public function display($req, $res, $args)
    {
        ...
        if (Input::query('find_user')) {
            ...
            $can_delete = $can_move = Container::get('user')->g_id == Config::get('forum_env')['FEATHER_ADMIN'];
            $can_ban = Container::get('user')->g_id == Config::get('forum_env')['FEATHER_ADMIN'] || (Container::get('user')->g_moderator == '1' && Container::get('user')->g_mod_ban_users == '1');
