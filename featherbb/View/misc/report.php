            ...
            <div class="inform">
                <fieldset>
                    ...
                    <div class="infldset txtarea">
                        ...
                        <label class="required"><strong><?= __('Reason') ?> <span><?= __('Required') ?></span></strong><br /><textarea name="req_reason" rows="5" cols="60" required="required" autofocus></textarea><br /></label>
                    </div>
                </fieldset>
            </div>
