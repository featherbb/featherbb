                ...
                <fieldset>
                    ...
                    <div class="infldset">
                        ...
                        <ul class="bblinks">
                            ...
                            <li><span><a href="<?= Router::pathFor('help').'#smilies' ?>" onclick="window.open(this.href); return false;"><?php _e('Smilies') ?></a> <?= (ForumSettings::get('smilies.sig') == '1') ? __('on') : __('off'); ?></span></li>
                        </ul>
                        <?= $signature_preview ?>
                    </div>
                </fieldset>
