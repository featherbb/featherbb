                ...
                <div class="blockform">
                    ...
                    <div class="box">
                        <form id="profile1" method="post" action="<?= Router::pathFor('profileSection', ['id' => $id, 'section' => 'essentials']) ?>">
                            ...
                            <div class="inform">
                                <fieldset>
                                    <legend><?= __('Username and pass legend') ?></legend>
                                    <div class="infldset">
                                        <input type="hidden" name="form_sent" value="1" />
                                        <?= $user_disp['username_field'] ?>
<?php if (User::get()->id == $id || User::isAdmin() || (User::isAdminMod() && User::can('mod.change_passwords'))): ?>
                                        <p class="actions"><span><a href="<?= Router::pathFor('profileAction', ['id' => $id, 'action' => 'change_pass']) ?>"><?= __('Change pass') ?></a></span></p>
<?php endif; ?>
                                    </div>
                                </fieldset>
                            </div>
