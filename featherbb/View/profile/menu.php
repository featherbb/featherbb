...
<?php if (Container::get('user')->g_id == $feather->forum_env['FEATHER_ADMIN'] || (Container::get('user')->g_moderator == '1' && Container::get('user')->g_mod_ban_users == '1')): ?>                    <li<?php if ($page == 'admin') {
    echo ' class="isactive"';
}
