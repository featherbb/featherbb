...
<?php if (!User::isAdminMod()): ?>
                                    <label class="required"><strong><?php _e('Old pass') ?> <span><?php _e('Required') ?></span></strong><br />
                                    <input type="password" name="req_old_password" size="16" required="required" autofocus /><br /></label>
<?php endif; ?>
                                    <label class="conl required"><strong><?php _e('New pass') ?> <span><?php _e('Required') ?></span></strong><br />
                                    <input type="password" name="req_new_password1" size="16" required="required"<?= (User::isAdminMod()) ? ' autofocus' : ''; ?> /><br /></label>
