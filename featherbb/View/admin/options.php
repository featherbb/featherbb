...
?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name="form_default_timezone">
                                            <option value="-12"<?php if (ForumSettings::get('o_default_timezone') == -12) {
    echo ' selected="selected"';
} ?>><?php _e('UTC-12:00') ?></option>
                                            <option value="-11"<?php if (ForumSettings::get('o_default_timezone') == -11) {
    echo ' selected="selected"';
} ?>><?php _e('UTC-11:00') ?></option>
                                            <option value="-10"<?php if (ForumSettings::get('o_default_timezone') == -10) {
    echo ' selected="selected"';
} ?>><?php _e('UTC-10:00') ?></option>
                                            <option value="-9.5"<?php if (ForumSettings::get('o_default_timezone') == -9.5) {
    echo ' selected="selected"';
} ?>><?php _e('UTC-09:30') ?></option>
                                            <option value="-9"<?php if (ForumSettings::get('o_default_timezone') == -9) {
    echo ' selected="selected"';
} ?>><?php _e('UTC-09:00') ?></option>
                                            <option value="-8.5"<?php if (ForumSettings::get('o_default_timezone') == -8.5) {
    echo ' selected="selected"';
} ?>><?php _e('UTC-08:30') ?></option>
                                            <option value="-8"<?php if (ForumSettings::get('o_default_timezone') == -8) {
    echo ' selected="selected"';
} ?>><?php _e('UTC-08:00') ?></option>
                                            <option value="-7"<?php if (ForumSettings::get('o_default_timezone') == -7) {
    echo ' selected="selected"';
} ?>><?php _e('UTC-07:00') ?></option>
                                            <option value="-6"<?php if (ForumSettings::get('o_default_timezone') == -6) {
    echo ' selected="selected"';
} ?>><?php _e('UTC-06:00') ?></option>
                                            <option value="-5"<?php if (ForumSettings::get('o_default_timezone') == -5) {
    echo ' selected="selected"';
} ?>><?php _e('UTC-05:00') ?></option>
                                            <option value="-4"<?php if (ForumSettings::get('o_default_timezone') == -4) {
    echo ' selected="selected"';
} ?>><?php _e('UTC-04:00') ?></option>
                                            <option value="-3.5"<?php if (ForumSettings::get('o_default_timezone') == -3.5) {
    echo ' selected="selected"';
} ?>><?php _e('UTC-03:30') ?></option>
                                            <option value="-3"<?php if (ForumSettings::get('o_default_timezone') == -3) {
    echo ' selected="selected"';
} ?>><?php _e('UTC-03:00') ?></option>
                                            <option value="-2"<?php if (ForumSettings::get('o_default_timezone') == -2) {
    echo ' selected="selected"';
} ?>><?php _e('UTC-02:00') ?></option>
                                            <option value="-1"<?php if (ForumSettings::get('o_default_timezone') == -1) {
    echo ' selected="selected"';
} ?>><?php _e('UTC-01:00') ?></option>
                                            <option value="0"<?php if (ForumSettings::get('o_default_timezone') == 0) {
    echo ' selected="selected"';
} ?>><?php _e('UTC') ?></option>
                                            <option value="1"<?php if (ForumSettings::get('o_default_timezone') == 1) {
    echo ' selected="selected"';
    ...
    echo ' selected="selected"';
                                            ...
                                            <option value="4.5"<?php if (ForumSettings::get('o_default_timezone') == 4.5) {
    echo ' selected="selected"';
} ?>><?php _e('UTC+04:30') ?></option>
                                            <option value="5"<?php if (ForumSettings::get('o_default_timezone') == 5) {
    echo ' selected="selected"';
} ?>><?php _e('UTC+05:00') ?></option>
                                            <option value="5.5"<?php if (ForumSettings::get('o_default_timezone') == 5.5) {
    echo ' selected="selected"';
} ?>><?php _e('UTC+05:30') ?></option>
                                            <option value="5.75"<?php if (ForumSettings::get('o_default_timezone') == 5.75) {
    echo ' selected="selected"';
} ?>><?php _e('UTC+05:45') ?></option>
                                            <option value="6"<?php if (ForumSettings::get('o_default_timezone') == 6) {
    echo ' selected="selected"';
} ?>><?php _e('UTC+06:00') ?></option>
                                            <option value="6.5"<?php if (ForumSettings::get('o_default_timezone') == 6.5) {
    echo ' selected="selected"';
    ...
    echo ' selected="selected"';
                                            ...
                                            <option value="8.75"<?php if (ForumSettings::get('o_default_timezone') == 8.75) {
    echo ' selected="selected"';
    ...
    echo ' selected="selected"';
                                            ...
                                            <option value="10.5"<?php if (ForumSettings::get('o_default_timezone') == 10.5) {
    echo ' selected="selected"';
} ?>><?php _e('UTC+10:30') ?></option>
                                            <option value="11"<?php if (ForumSettings::get('o_default_timezone') == 11) {
    echo ' selected="selected"';
} ?>><?php _e('UTC+11:00') ?></option>
                                            <option value="11.5"<?php if (ForumSettings::get('o_default_timezone') == 11.5) {
    echo ' selected="selected"';
} ?>><?php _e('UTC+11:30') ?></option>
                                            <option value="12"<?php if (ForumSettings::get('o_default_timezone') == 12) {
    echo ' selected="selected"';
} ?>><?php _e('UTC+12:00') ?></option>
                                            <option value="12.75"<?php if (ForumSettings::get('o_default_timezone') == 12.75) {
    echo ' selected="selected"';
} ?>><?php _e('UTC+12:45') ?></option>
                                            <option value="13"<?php if (ForumSettings::get('o_default_timezone') == 13) {
    echo ' selected="selected"';
} ?>><?php _e('UTC+13:00') ?></option>
                                            <option value="14"<?php if (ForumSettings::get('o_default_timezone') == 14) {
    echo ' selected="selected"';
...
?>
    ...
    echo ' checked="checked"';
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label class="conl"><input type="radio" name="form_smilies_sig" value="1"<?php if (ForumSettings::get('o_smilies_sig') == '1') {
    echo ' checked="checked"';
} ?> />&#160;<strong><?php _e('Yes') ?></strong></label>
                                        <label class="conl"><input type="radio" name="form_smilies_sig" value="0"<?php if (ForumSettings::get('o_smilies_sig') == '0') {
    echo ' checked="checked"';
} ?> />&#160;<strong><?php _e('No') ?></strong></label>
