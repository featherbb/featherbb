...
<div class="box">
    <div class="inbox">
        ...
        <p><code>[post=1]<?php _e('Test post') ?>[/post]</code> <?php _e('produces') ?> <samp><a href="<?= Router::pathFor('viewPost', ['id' => '1', 'name' => 'test-topic', 'pid' => '1']).'#1' ?>"><?php _e('Test post') ?></a></samp></p>
        <p><code>[post]1[/post]</code> <?php _e('produces') ?> <samp><a href="<?= Router::pathFor('viewPost', ['id' => '1', 'name' => 'test-topic', 'pid' => '1']).'#1' ?>"><?= Router::pathFor('viewPost', ['id' => '1', 'name' => 'test-topic', 'pid' => '1']).'#1' ?></a></samp></p>
