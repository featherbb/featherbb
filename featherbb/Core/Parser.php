...
class Parser
{
    ...
    public function parse_bbcode(&$text, $hide_smilies = 0)
    {
        ...
        {
            $smile_on = ($this->feather->config['o_smilies_sig'] && Container::get('user')['show_smilies'] && !$hide_smilies) ? 1 : 0;
        }
        else
        {
            $smile_on = ($this->feather->config['o_smilies'] && Container::get('user')['show_smilies'] && !$hide_smilies) ? 1 : 0;
        }
    ...
    public function parse_message($text, $hide_smilies)
    {
        ...
        if ($this->feather->config['p_message_img_tag'] !== '1' || Container::get('user')['show_img'] !== '1')
    ...
    public function parse_signature($text)
    {
        ...
        if ($this->feather->config['p_sig_img_tag'] !== '1' || Container::get('user')['show_img_sig'] !== '1')
            if (isset($this->pd['bbcd']['img']))
