...
class users
{
    ...
    public function display()
    {
        ...
        if ($this->feather->request->post('move_users') || $this->feather->request->post('move_users_comply')) {
            ...
            $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), $lang_admin_common['Admin'], $lang_admin_common['Users'], $lang_admin_users['Move users']);
        ...
        if ($this->feather->request->post('delete_users') || $this->feather->request->post('delete_users_comply')) {
            ...
            $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), $lang_admin_common['Admin'], $lang_admin_common['Users'], $lang_admin_users['Delete users']);
        ...
        if ($this->feather->request->get('find_user')) {
            ...
            $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), $lang_admin_common['Admin'], $lang_admin_common['Users'], $lang_admin_users['Results head']);
        ...
        $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), $lang_admin_common['Admin'], $lang_admin_common['Users']);
