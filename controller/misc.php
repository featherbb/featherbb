...
namespace controller{
    ...
    class Misc{
        ...
        function email($id){
			...
			$redirect_url = get_redirect_url($feather, $id);

			$page_title = array(pun_htmlspecialchars($pun_config['o_board_title']), $lang_misc['Send email to'].' '.pun_htmlspecialchars($mail['recipient']));
