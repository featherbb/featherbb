...
class profile
{
    ...
    public function display($id, $section = null)
    {
        ...
        if ($this->feather->request->post('update_group_membership')) {
            ...
            $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), $lang_common['Profile'], $lang_profile['Confirm delete user']);
        ...
        if ($this->user['id'] != $id &&                                                                    // If we aren't the user (i.e. editing your own profile)
            ...
            $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), sprintf($lang_profile['Users profile'], pun_htmlspecialchars($user['username'])));
            ...
            if (!$section || $section == 'essentials') {
                ...
                $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), $lang_common['Profile'], $lang_profile['Section essentials']);
                ...
                $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), $lang_common['Profile'], $lang_profile['Section personal']);
                ...
                $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), $lang_common['Profile'], $lang_profile['Section messaging']);
                ...
                $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), $lang_common['Profile'], $lang_profile['Section personality']);
                ...
                $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), $lang_common['Profile'], $lang_profile['Section display']);
                ...
                $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), $lang_common['Profile'], $lang_profile['Section privacy']);
                ...
                $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), $lang_common['Profile'], $lang_profile['Section admin']);
    ...
    public function action($id, $action)
    {
        ...
        if ($action == 'change_pass') {
            ...
            $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), $lang_common['Profile'], $lang_profile['Change pass']);
            ...
            $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), $lang_common['Profile'], $lang_profile['Change email']);
            ...
            $page_title = array(pun_htmlspecialchars($this->config['o_board_title']), $lang_common['Profile'], $lang_profile['Upload avatar']);
