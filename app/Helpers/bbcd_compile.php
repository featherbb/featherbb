...
// or from an admin page web form) into the app/cache/cache_parser_data.php.
...
$file_path = FEATHER_ROOT . 'style/img/smilies/';                // File system path to smilies.
...
$s .= "?>";
file_put_contents(FEATHER_ROOT.'app/cache/cache_parser_data.php', $s);
