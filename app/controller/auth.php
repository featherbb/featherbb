...
class auth
{
    public function __construct()
    {
        ...
        load_textdomain('featherbb', FEATHER_ROOT.'app/lang/'.$this->feather->user->language.'/login.mo');
    }
    ...
    public function forget()
    {
        ...
        if ($this->feather->request->isPost()) {
            ...
            if ($user) {
                ...
                $mail_tpl = trim(file_get_contents(FEATHER_ROOT.'app/lang/'.$this->feather->user->language.'/mail_templates/activate_password.tpl'));
