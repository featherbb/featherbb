...
class install
{
    protected $database_scheme = array(
        ...
        'censoring' => "CREATE TABLE `censoring` (
            `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
        ...
        'forum_perms' => "CREATE TABLE `forum_perms` (
        ...
        'forum_subscriptions' => "CREATE TABLE `forum_subscriptions` (
        ...
        'search_cache' => "CREATE TABLE `search_cache` (
        ...
        'search_matches' => "CREATE TABLE `search_matches` (
            `post_id` int(10) unsigned NOT NULL DEFAULT '0',
        ...
        'search_words' => "CREATE TABLE `search_words` (
            `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
            `word` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
            PRIMARY KEY (`word`),
            KEY `search_words_id_idx` (`id`)
        ) ENGINE=MyISAM DEFAULT CHARSET=utf8;",
        'topic_subscriptions' => "CREATE TABLE `topic_subscriptions` (
            `user_id` int(10) unsigned NOT NULL DEFAULT '0',
            `topic_id` int(10) unsigned NOT NULL DEFAULT '0',
