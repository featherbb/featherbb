            ...
            foreach($result as $cur_subscriber) {
                ...
                if (!isset($notification_emails[$cur_subscriber['language']])) {
                    if (file_exists(FEATHER_ROOT.'lang/'.$cur_subscriber['language'].'/mail_templates/new_reply.tpl')) {
                        ...
                        $mail_message = str_replace('<post_url>', $this->feather->url->get_link('post/'.$new_pid.'/#p'.$new_pid), $mail_message);
                        $mail_message = str_replace('<unsubscribe_url>', $this->feather->url->get_link('unsubscribe/topic/'.$tid.'/'), $mail_message);
                        ...
                        $mail_message_full = str_replace('<post_url>', $this->feather->url->get_link('post/'.$new_pid.'/#p'.$new_pid), $mail_message_full);
                        $mail_message_full = str_replace('<unsubscribe_url>', $this->feather->url->get_link('unsubscribe/topic/'.$tid.'/'), $mail_message_full);
            ...
            foreach($result as $cur_subscriber) {
                ...
                if (!isset($notification_emails[$cur_subscriber['language']])) {
                    if (file_exists(FEATHER_ROOT.'lang/'.$cur_subscriber['language'].'/mail_templates/new_topic.tpl')) {
                        ...
                        $mail_message = str_replace('<topic_url>', $this->feather->url->get_link('topic/'.$new_tid.'/'), $mail_message);
                        $mail_message = str_replace('<unsubscribe_url>', $this->feather->url->get_link('unsubscribe/topic/'.$cur_posting['id'].'/'), $mail_message);
                        $mail_message = str_replace('<board_mailer>', $this->config['o_board_title'], $mail_message);
                        ...
                        $mail_message_full = str_replace('<message>', $cleaned_message, $mail_message_full);
                        $mail_message_full = str_replace('<topic_url>', $this->feather->url->get_link('topic/'.$new_tid.'/'), $mail_message_full);
                        $mail_message_full = str_replace('<unsubscribe_url>', $this->feather->url->get_link('unsubscribe/topic/'.$cur_posting['id'].'/'), $mail_message_full);
                        $mail_message_full = str_replace('<board_mailer>', $this->config['o_board_title'], $mail_message_full);
