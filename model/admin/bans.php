...
class bans
{
    ...
    public function add_ban_info($id = null)
    {
        ...
        if (isset($group_id)) {
            if ($group_id == FEATHER_ADMIN) {
                throw new \FeatherBB\Error(sprintf(__('User is admin message'), feather_escape($ban['ban_user'])), 403);
            }
            ...
            if ($is_moderator_group) {
                throw new \FeatherBB\Error(sprintf(__('User is mod message'), feather_escape($ban['ban_user'])), 403);
            }
        }
    ...
    public function insert_ban()
    {
        ...
        if (!empty($ban_user)) {
            ...
            if ($group_id) {
                if ($group_id == FEATHER_ADMIN) {
                    throw new \FeatherBB\Error(sprintf(__('User is admin message'), feather_escape($ban_user)), 403);
                }
                ...
                if ($is_moderator_group) {
                    throw new \FeatherBB\Error(sprintf(__('User is mod message'), feather_escape($ban_user)), 403);
                }
            }
        }
