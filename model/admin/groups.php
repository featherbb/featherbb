...
class groups
{
    ...
    public function add_edit_group($groups)
    {
        ...
        if ($this->request->post('mode') == 'edit') {
            redirect($this->feather->url->get_link('admin/groups/'), __('Group edited redirect'));
        } else {
            redirect($this->feather->url->get_link('admin/groups/'), __('Group added redirect'));
        }
    }
    ...
    public function set_default_group($groups)
    {
        ...
        redirect($this->feather->url->get_link('admin/groups/'), __('Default group redirect'));
    }
    ...
    public function delete_group($group_id)
    {
        ...
        redirect($this->feather->url->get_link('admin/groups/'), __('Group removed redirect'));
    }
