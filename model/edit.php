...
{
    global $db, $feather_user, $feather_config, $lang_post, $pd;
...
function edit_post($id, $can_edit_subject, $post, $cur_post, $feather, $is_admmod)
{
    ...
    $edited_sql = (!$feather->request->post('slient') || !$is_admmod) ? ', edited='.time().', edited_by=\''.$db->escape($feather_user['username']).'\'' : '';
...
{
    global $lang_post, $lang_common, $feather_config;
